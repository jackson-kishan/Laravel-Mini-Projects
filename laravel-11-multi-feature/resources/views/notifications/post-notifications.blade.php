                ...
                <div class="card-body">
                    ...
                    @foreach(auth()->user()->unreadNotifications as $notification)
                        <div class="alert alert-success alert-dismissible fade show">
                            ...
                            <a href="{{ route('notify.posts.mark.as.read', $notification->id) }}" class="close" data-dismiss="alert" aria-label="Close">
                    ...
                    <form method="post" action="{{ route('notify.posts.store') }}" enctype="multipart/form-data">
                        @csrf
                        ...
                        <tbody>
                            @forelse($posts as $post)
                                <tr>
                                    ...
                                    <td>
                                        @if(!$post->is_approved)
                                            <a href="{{ route('notify.posts.approve', $post->id) }}" class="btn btn-success btn-sm"><i class="fa fa-save"></i> Approved</a>
                                        @endif
                                    </td>
                                    @endif
                                </tr>
